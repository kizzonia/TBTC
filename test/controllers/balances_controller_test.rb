...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { balance: @balance.balance, resources: @balance.resources } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { balance: @balance.balance, resources: @balance.resources } }
